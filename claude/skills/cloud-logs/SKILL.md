...
**주의: admin-api의 URL prefix**
- admin-api 서비스의 요청 URL은 `/admin-api/` prefix를 사용한다 (예: `/admin-api/auth/authed-bridge-url/{uid}`)
- api 서비스는 `/api/` prefix (예: `/api/auth/bridge-token-info`)
